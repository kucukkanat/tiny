// Statement form, not an inline `type`: under `verbatimModuleSyntax` the inline
// one leaves a live index -> provider -> index edge in the module that boots
// everything.
import type { Provider, Registry } from './index'
